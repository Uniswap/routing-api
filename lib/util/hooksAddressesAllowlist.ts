...
export const HOOKS_ADDRESSES_ALLOWLIST: { [chain in ChainId]: Array<string> } = {
  [ChainId.MAINNET]: [
    EMA_DYNAMIC_FEE_HOOK_ON_MAINNET,
    ADDRESS_ZERO,
  ...
  [ChainId.OPTIMISM]: [EMA_DYNAMIC_FEE_HOOK_ON_OPTIMISM,ADDRESS_ZERO, WETH_HOOKS_ADDRESS_ON_OP_MAINNET, FINDEX_HOOK_ON_OPTIMISM],
  [ChainId.OPTIMISM_GOERLI]: [ADDRESS_ZERO],
  [ChainId.OPTIMISM_SEPOLIA]: [ADDRESS_ZERO],
  [ChainId.ARBITRUM_ONE]: [
    EMA_DYNAMIC_FEE_HOOK_ON_ARBITRUM,
    ADDRESS_ZERO,
  ...
  [ChainId.POLYGON]: [EMA_DYNAMIC_FEE_HOOK_ON_POLYGON,ADDRESS_ZERO, AEGIS_V1_1_ON_POLYGON],
  ...
  [ChainId.UNICHAIN]: [
    EMA_DYNAMIC_FEE_HOOK_ON_UNICHAIN,
    ADDRESS_ZERO,
    RENZO_ON_UNICHAIN,
