...
export const FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_OPTIMISN = '0xb35297543D357eF62df204D8c3Bd0E96038CF440'
export const FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_MAINNET = '0x82c7FF818359d9F78Dcd04538aa819bB89683440'
export const FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_POLYGON = '0xe44E9631E9EC92302Ee5b54fBcd87330D079B440'
export const FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_BSC = '0x85C2BE3C314d90316f88b559fE087265f09C7440'
export const FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_ARBITRUM = '0x214B6E39034eA62c618abb27A601AF9F185eF440'
export const FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_BASE = '0x1AEEe41D569AF2b9df1B39A6905253D2a8297440'
export const FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_UNICHAIN = '0x8E8e01AEBE36441b6209927C38F8C7D716c8B440'
...
export const HOOKS_ADDRESSES_ALLOWLIST: { [chain in ChainId]: Array<string> } = {
  [ChainId.MAINNET]: [
    ...
    FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_MAINNET,
  ],
  [ChainId.GOERLI]: [ADDRESS_ZERO],
  [ChainId.SEPOLIA]: [ADDRESS_ZERO, extraHooksAddressesOnSepolia, FEY_ON_SEPOLIA],
  [ChainId.OPTIMISM]: [ADDRESS_ZERO, WETH_HOOKS_ADDRESS_ON_OP_MAINNET, FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_OPTIMISN],
  ...
  [ChainId.ARBITRUM_ONE]: [
    ...
    FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_ARBITRUM,
  ],
  [ChainId.ARBITRUM_GOERLI]: [ADDRESS_ZERO],
  [ChainId.ARBITRUM_SEPOLIA]: [ADDRESS_ZERO],
  [ChainId.POLYGON]: [ADDRESS_ZERO, FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_POLYGON],
  ...
  [ChainId.BNB]: [ADDRESS_ZERO, FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_BSC],
  ...
  [ChainId.BASE]: [
    ...
    FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_BASE,
  ],
  ...
  [ChainId.UNICHAIN]: [
    ...
    FINDEX_DYNAMIC_FEE_HOOK_ADDRESS_ON_UNICHAIN,
  ],
