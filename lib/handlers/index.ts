...
const quoteToRatioInjectorPromise = new QuoteToRatioHandlerInjector(
  'quoteToRatioInjector'
).build();

const quoteHandler = new QuoteHandler('quote', quoteInjectorPromise);
const quoteToRatioHandler = new QuoteToRatioHandler(
  'quote-to-ratio',
  quoteToRatioInjectorPromise
);
