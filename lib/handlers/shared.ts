...
export const DEFAULT_ROUTING_CONFIG_BY_CHAIN = (chainId: ChainId,
                                                ...
                                                topNWithBaseToken?: number): AlphaRouterConfig => {
  switch (chainId) {
    case ChainId.BASE:
    case ChainId.OPTIMISM:
      return {
        v2PoolSelection: {
          topN: topN ?? 3,
          topNDirectSwaps: topNDirectSwaps ?? 1,
          topNTokenInOut: topNTokenInOut ?? 5,
          topNSecondHop: topNSecondHop ?? 2,
          topNWithEachBaseToken: topNWithEachBaseToken ?? 2,
          topNWithBaseToken: topNWithBaseToken ?? 6,
        },
        v3PoolSelection: {
          topN: topN ?? 2,
          topNDirectSwaps: topNDirectSwaps ?? 2,
          topNTokenInOut: topNTokenInOut ?? 2,
          topNSecondHop: topNSecondHop ?? 1,
          topNWithEachBaseToken: topNWithEachBaseToken ?? 3,
          topNWithBaseToken: topNWithBaseToken ?? 3,
        },
    ...
    case ChainId.ARBITRUM_ONE:
      return {
        ...
        v3PoolSelection: {
          ...
          topNSecondHop: topNSecondHop ?? 1,
          topNWithEachBaseToken: topNWithEachBaseToken ?? 3,
          topNWithBaseToken: topNWithBaseToken ?? 2,
        },
        maxSwapsPerPath: maxSwapsPerPath ?? 2,
        minSplits: 1,
        maxSplits: maxSplits ?? 7,
        distributionPercent: distributionPercent ?? 25,
        forceCrossProtocol: false,
      }
    default:
      return {
