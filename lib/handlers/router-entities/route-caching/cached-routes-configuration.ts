  ...
  [
    ...
    new CachedRoutesStrategy({
      ...
      buckets: [
        ...
        new CachedRoutesBucket({ bucket: 0.1, cacheMode: CacheMode.Livemode, withLastNCachedRoutes: 10 }),
        new CachedRoutesBucket({ bucket: 0.5, cacheMode: CacheMode.Livemode, withLastNCachedRoutes: 10 }),
        new CachedRoutesBucket({ bucket: 1, cacheMode: CacheMode.Livemode, withLastNCachedRoutes: 10 }),
        new CachedRoutesBucket({ bucket: 2, cacheMode: CacheMode.Livemode, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 4, cacheMode: CacheMode.Livemode, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 6, cacheMode: CacheMode.Livemode, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 10, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 3 }),
        new CachedRoutesBucket({ bucket: 16, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 3 }),
        new CachedRoutesBucket({ bucket: 30, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 3 }),
        new CachedRoutesBucket({ bucket: 45, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 3 }),
        new CachedRoutesBucket({ bucket: 80, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 3 }),
        new CachedRoutesBucket({ bucket: 99, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 3 }),
