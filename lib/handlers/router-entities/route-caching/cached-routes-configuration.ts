...
export const CACHED_ROUTES_CONFIGURATION: Map<string, CachedRoutesStrategy> = new Map([
  ...
  [
    ...
    new CachedRoutesStrategy({
      ...
      chainId: ChainId.MAINNET,
      buckets: [
        new CachedRoutesBucket({ bucket: 0.0025, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 0.006, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 0.025, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 0.06, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 0.25, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 0.6, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 1, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 2, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 3, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 4, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
        new CachedRoutesBucket({ bucket: 5, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 5 }),
      ],
    }),
  ],
])
