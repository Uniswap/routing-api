...
export const CACHED_ROUTES_CONFIGURATION: Map<string, CachedRoutesStrategy> = new Map([
  [
    ...
    new CachedRoutesStrategy([
      new CachedRoutesParameters({ bucket: 1, blocksToLive: 1, cacheMode: CacheMode.Livemode }),
      new CachedRoutesParameters({ bucket: 2, blocksToLive: 1, cacheMode: CacheMode.Livemode }),
      new CachedRoutesParameters({ bucket: 5, blocksToLive: 1, cacheMode: CacheMode.Livemode }),
      new CachedRoutesParameters({ bucket: 10, blocksToLive: 1, cacheMode: CacheMode.Tapcompare }),
      new CachedRoutesParameters({ bucket: 30, blocksToLive: 1, cacheMode: CacheMode.Tapcompare }),
  ...
  [
    ...
    new CachedRoutesStrategy([
      new CachedRoutesParameters({ bucket: 100, blocksToLive: 1, cacheMode: CacheMode.Livemode }),
      new CachedRoutesParameters({ bucket: 250, blocksToLive: 1, cacheMode: CacheMode.Livemode }),
      new CachedRoutesParameters({ bucket: 500, blocksToLive: 1, cacheMode: CacheMode.Livemode }),
      new CachedRoutesParameters({ bucket: 1000, blocksToLive: 1, cacheMode: CacheMode.Tapcompare }),
      new CachedRoutesParameters({ bucket: 3000, blocksToLive: 1, cacheMode: CacheMode.Tapcompare }),
