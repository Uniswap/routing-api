...
export const CACHED_ROUTES_CONFIGURATION: Map<string, CachedRoutesStrategy> = new Map([
  ...
  [
    ...
    new CachedRoutesStrategy({
      ...
      chainId: ChainId.MAINNET,
      buckets: [
        new CachedRoutesBucket({ bucket: 75, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 10 }),
        new CachedRoutesBucket({ bucket: 150, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 10 }),
        new CachedRoutesBucket({ bucket: 250, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 10 }),
        new CachedRoutesBucket({ bucket: 400, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 10 }),
        new CachedRoutesBucket({ bucket: 550, cacheMode: CacheMode.Tapcompare, withLastNCachedRoutes: 10 }),
