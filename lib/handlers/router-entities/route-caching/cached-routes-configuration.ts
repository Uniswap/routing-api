  ...
  [
    ...
    new CachedRoutesStrategy({
      ...
      buckets: [
        ...
        new CachedRoutesBucket({ bucket: 0.25, cacheMode: CacheMode.Tapcompare, maxSplits: 1 }),
        new CachedRoutesBucket({ bucket: 0.6, cacheMode: CacheMode.Tapcompare, maxSplits: 1 }),
