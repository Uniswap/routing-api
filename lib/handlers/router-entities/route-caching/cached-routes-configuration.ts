...
export const CACHED_ROUTES_CONFIGURATION: Map<string, CachedRoutesStrategy> = new Map([
  ...
  [
    ...
    new CachedRoutesStrategy({
      ...
      buckets: [
        ...
        new CachedRoutesBucket({ bucket: 0.05, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 0.1, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 0.5, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 1, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 2, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 3, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 4, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 5, cacheMode: CacheMode.Livemode }),
      ],
    }),
  ],
  [
    ...
    new CachedRoutesStrategy({
      ...
      chainId: ChainId.MAINNET,
      buckets: [
        new CachedRoutesBucket({ bucket: 100, cacheMode: CacheMode.Darkmode }),
        new CachedRoutesBucket({ bucket: 300, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 500, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 750, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 1_000, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 3_000, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 8_000, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 13_000, cacheMode: CacheMode.Livemode }),
  ...
  [
    ...
    new CachedRoutesStrategy({
      ...
      buckets: [
        ...
        new CachedRoutesBucket({ bucket: 0.1, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.5, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 1, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 2, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 4, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 6, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 10, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 16, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 30, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 45, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 55, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 80, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 95, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 110, cacheMode: CacheMode.Tapcompare }),
      ],
    }),
  ],
])
