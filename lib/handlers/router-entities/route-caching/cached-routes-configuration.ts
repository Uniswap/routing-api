...
export const CACHED_ROUTES_CONFIGURATION: Map<string, CachedRoutesStrategy> = new Map([
  ...
  [
    ...
    new CachedRoutesStrategy({
      ...
      chainId: ChainId.MAINNET,
      buckets: [
        new CachedRoutesBucket({ bucket: 100, cacheMode: CacheMode.Livemode }),
        new CachedRoutesBucket({ bucket: 250, cacheMode: CacheMode.Livemode }),
        ...
        new CachedRoutesBucket({ bucket: 2_000, cacheMode: CacheMode.Livemode }),
        ...
        new CachedRoutesBucket({ bucket: 144_000, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 233_000, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 377_000, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 610_000, cacheMode: CacheMode.Tapcompare }),
      ],
    }),
  ],
  [
    ...
    new CachedRoutesStrategy({
      ...
      chainId: ChainId.MAINNET,
      buckets: [
        new CachedRoutesBucket({ bucket: 0.001, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.0025, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.006, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.01, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.025, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.06, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.1, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.25, cacheMode: CacheMode.Tapcompare }),
        new CachedRoutesBucket({ bucket: 0.6, cacheMode: CacheMode.Tapcompare }),
