      ...
      },
      {
        ...
        properties: {
          ...
          metrics: [
            ...
            [this.namespace, 'GetCachedRoute_hit_livemode', 'Service', 'RoutingAPI', { label: 'Cache Hit', id: 'm1', visible: false }],
      ...
      },
      {
        ...
        properties: {
          ...
          metrics: [
            ...
            [ { expression: 'm1/e1 * 100', label: 'Cache Hit Rate', id: 'e2' } ],
            [ { expression: 'm2/e1 * 100', label: 'Cache Miss Rate', id: 'e3' } ],
            [this.namespace, 'GetCachedRoute_hit_tapcompare', 'Service', 'RoutingAPI', { label: 'Cache Hit', id: 'm1', visible: false }],
    ...
    const widget: Widget[] = [
      {
        ...
        properties: {
          ...
          query: `SOURCE '/aws/lambda/${this.lambdaName}'
            | fields @timestamp, pair, quoteGasAdjustedDiff as diffOf${tokenOut}, amount as amountOf${tokenIn}, quoteGasAdjustedDiff * (amount/quoteGasAdjustedFromChain) as diffIn${tokenIn}Terms, diffIn${tokenIn}Terms / amount * 100 as misquotePercent
