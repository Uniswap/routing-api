...
interface PegasysInterfaceMulticallInterface extends ethers.utils.Interface {
  functions: {
...
export class PegasysInterfaceMulticall extends BaseContract {
  ...
  interface: PegasysInterfaceMulticallInterface;
