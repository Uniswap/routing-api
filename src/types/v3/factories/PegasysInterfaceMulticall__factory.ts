...
import type {
  PegasysInterfaceMulticall,
  PegasysInterfaceMulticallInterface,
} from "../PegasysInterfaceMulticall";
  ...
  },
  {
    inputs: [
      {
        ...
        internalType: "struct PegasysInterfaceMulticall.Call[]",
        name: "calls",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      ...
      },
      {
        ...
        internalType: "struct PegasysInterfaceMulticall.Result[]",
        name: "returnData",
        type: "tuple[]",
      },
    ],
...
export class PegasysInterfaceMulticall__factory extends ContractFactory {
  constructor(
  ...
  ): Promise<PegasysInterfaceMulticall> {
    return super.deploy(overrides || {}) as Promise<PegasysInterfaceMulticall>;
  }
  ...
  attach(address: string): PegasysInterfaceMulticall {
    return super.attach(address) as PegasysInterfaceMulticall;
  }
  connect(signer: Signer): PegasysInterfaceMulticall__factory {
    return super.connect(signer) as PegasysInterfaceMulticall__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PegasysInterfaceMulticallInterface {
    return new utils.Interface(_abi) as PegasysInterfaceMulticallInterface;
  }
  static connect(
    address: string,
