...
describe('ProdConfig', () => {
  it('test generate json string from ProdConfig', () => {
    ...
    expect(jsonStr).equal('[{"chainId":1,"useMultiProvider":false},{"chainId":43114,"useMultiProvider":true,"sessionAllowProviderFallbackWhenUnhealthy":true,"providerInitialWeights":[-1,-1],"providerUrls":["url1","url2"]}]')
  })

  it('test parse json string into ProdConfig with validation, good case', () => {
    const jsonStr = '[{"chainId":1,"useMultiProvider":false},{"chainId":43114,"useMultiProvider":true,"sessionAllowProviderFallbackWhenUnhealthy":true,"providerInitialWeights":[-1,-1],"providerUrls":["url1","url2"]}]'
