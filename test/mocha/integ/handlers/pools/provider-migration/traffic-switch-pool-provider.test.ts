...
import { CachingV3PoolProvider, MetricLoggerUnit, NodeJSCache } from '@juiceswapxyz/smart-order-router'
...
} from '@juiceswapxyz/smart-order-router/build/main/providers/token-provider'
