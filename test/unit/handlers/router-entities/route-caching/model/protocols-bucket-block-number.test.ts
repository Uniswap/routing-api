...
import {
  ProtocolsBucketBlockNumber
} from '../../../../../../lib/handlers/router-entities/route-caching/model/protocols-bucket-block-number'
...
describe('ProtocolsBucketBlockNumber', () => {
  describe('#fullKey', () => {
    it('returns a string-ified version of the object', () => {
      ...
      expect(protocolsBucketBlockNumber.fullKey()).to.eq(
        "MIXED,V2,V3/5/12345"
      )
    })
    ...
    it('throws an error when the bucketNumber is undefined', () => {
      ...
      expect(() => protocolsBucketBlockNumber.fullKey()).to.throw(
        "BlockNumber is necessary to create a fullKey"
      )
    })
  })
  ...
  describe('#protocolsBucketPartialKey', () => {
    it('returns a string-ified version of the object without the blockNumber', () => {
      ...
      expect(protocolsBucketBlockNumber.protocolsBucketPartialKey()).to.eq(
        "MIXED,V2,V3/5/"
      )
    })
