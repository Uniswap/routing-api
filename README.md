...
1. Install and configure [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2.html).
...
3. Install and build the package
   ...
   ```
4. To deploy the API, refer to the [Terraform Deployment Guide](TERRAFORM_DEPLOYMENT.md) for detailed instructions on deploying the infrastructure using Terraform.
