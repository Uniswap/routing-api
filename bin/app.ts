...
const jsonRpcProviders = {
  ...
  UNI_RPC_PROVIDER_INFURA_KEY: process.env.UNI_RPC_PROVIDER_INFURA_KEY!,
  UNI_RPC_PROVIDER_QUICKNODE_MAINNET_RPC_URL: process.env.UNI_RPC_PROVIDER_QUICKNODE_MAINNET_RPC_URL!,
