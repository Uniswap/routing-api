        ...
        properties: {
          ...
          metrics: _.flatMap(chains, (chainId) => [
            [
              ...
              'Service',
              'RoutingAPI',
              { stat: 'p99.99', label: `${ID_TO_NETWORK_NAME(chainId)} P99.99 Caching` },
            ],
            ['...', { stat: 'p99.9', label: `${ID_TO_NETWORK_NAME(chainId)} P99.9 Caching` }],
            ['...', { stat: 'p99', label: `${ID_TO_NETWORK_NAME(chainId)} P99 Caching` }],
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_CHAIN_${chainId}_INTENT_quote`,
              'Service',
              'RoutingAPI',
              { stat: 'p99.99', label: `${ID_TO_NETWORK_NAME(chainId)} P99.99 Quote` },
            ],
            ['...', { stat: 'p99.9', label: `${ID_TO_NETWORK_NAME(chainId)} P99.9 Quote` }],
            ['...', { stat: 'p99', label: `${ID_TO_NETWORK_NAME(chainId)} P99 Quote` }],
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_CHAIN_${chainId}_INTENT_swap`,
              'Service',
              'RoutingAPI',
              { stat: 'p99.99', label: `${ID_TO_NETWORK_NAME(chainId)} P99.99 Swap` },
            ],
            ['...', { stat: 'p99.9', label: `${ID_TO_NETWORK_NAME(chainId)} P99.9 Swap` }],
            ['...', { stat: 'p99', label: `${ID_TO_NETWORK_NAME(chainId)} P99 Swap` }],
          ]),
          region,
          title: `P99.X Latency by Chain and Intent`,
          period: 300,
          setPeriodToTimeRange: true,
          stat: 'SampleCount',
          yAxis: {
      ...
      },
      {
        ...
        properties: {
          ...
          metrics: _.flatMap(chains, (chainId) => [
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_CHAIN_${chainId}_QUOTE_SPEED_standard`,
              'Service',
              'RoutingAPI',
              { stat: 'p99.99', label: `${ID_TO_NETWORK_NAME(chainId)} P99.99 Standard` },
            ],
            ['...', { stat: 'p99.9', label: `${ID_TO_NETWORK_NAME(chainId)} P99.9 Standard` }],
            ['...', { stat: 'p99', label: `${ID_TO_NETWORK_NAME(chainId)} P99 Standard` }],
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_CHAIN_${chainId}_QUOTE_SPEED_fast`,
              'Service',
              'RoutingAPI',
              { stat: 'p99.99', label: `${ID_TO_NETWORK_NAME(chainId)} P99.99 Fast` },
            ],
            ['...', { stat: 'p99.9', label: `${ID_TO_NETWORK_NAME(chainId)} P99.9 Fast` }],
            ['...', { stat: 'p99', label: `${ID_TO_NETWORK_NAME(chainId)} P99 Fast` }],
          ]),
          region,
          title: `P99.X Latency by Chain and Quote Speed`,
          period: 300,
          setPeriodToTimeRange: true,
          stat: 'SampleCount',
          yAxis: {
        ...
        properties: {
          ...
          metrics: _.flatMap(chains, (chainId) => [
            [
              ...
              'Service',
              'RoutingAPI',
              { stat: 'p95', label: `${ID_TO_NETWORK_NAME(chainId)} P95 Fast` },
            ],
            ['...', { stat: 'p90', label: `${ID_TO_NETWORK_NAME(chainId)} P90 Standard` }],
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_CHAIN_${chainId}_QUOTE_SPEED_fast`,
              'Service',
            ...
            ['...', { stat: 'p90', label: `${ID_TO_NETWORK_NAME(chainId)} P90 Fast` }],
          ]),
          region,
          title: `P95 & P90 Latency by Chain and Quote Speed`,
          period: 300,
          setPeriodToTimeRange: true,
          stat: 'SampleCount',
          yAxis: {
